...
//         `INSERT INTO products (product_code, product_name, product_price, category_id, brand_id, status, description, image, discount_percentage, is_on_sale, is_new_arrival) 
//          VALUES (:product_code, :product_name, :product_price, :category_id, :brand_id, :status, :description, :image, :discount_percentage, :is_on_sale, :is_new_arrival)`,
//         {
//           replacements: {
...
//         p.category_id, p.brand_id, p.discount_percentage, p.is_on_sale, p.is_new_arrival,
...
//         ? `UPDATE products SET product_code=:product_code, product_name=:product_name, product_price=:product_price, category_id=:category_id, brand_id=:brand_id, status=:status, description=:description, image=:image, discount_percentage=:discount_percentage, is_on_sale=:is_on_sale, is_new_arrival=:is_new_arrival WHERE id=:id`
//         : `UPDATE products SET product_code=:product_code, product_name=:product_name, product_price=:product_price, category_id=:category_id, brand_id=:brand_id, status=:status, description=:description, discount_percentage=:discount_percentage, is_on_sale=:is_on_sale, is_new_arrival=:is_new_arrival WHERE id=:id`;
...
const ProductsListRepository = {
  ...
  // ekta specific category er discount product gula
  ...
  // shob category miliye shob discount product ("All Discount" page)
  getAllDiscountedProducts: async () => {
    try {
      const [rows] = await database.query(`
        SELECT 
  ...
  // ekta specific category er new arrival product gula
  ...
  // shob category miliye shob new arrival product ("New Arrivals" page)
  getAllNewArrivalProducts: async () => {
    try {
      const [rows] = await database.query(`
        SELECT 
